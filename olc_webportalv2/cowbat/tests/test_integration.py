...
class CowbatIntegrationTest(LiveServerTestCase):
    ...
    def test_cowbat_run(self):
        ...
        self.driver.find_element_by_xpath('//input[@type="file"]').send_keys(os.path.join(test_file_dir, 'GenerateFASTQRunStatistics.xml'))
        self.driver.find_element_by_xpath('//input[@type="file"]').send_keys(os.path.join(test_file_dir, 'RunInfo.xml'))
        self.driver.find_element_by_xpath('//input[@type="file"]').send_keys(os.path.join(test_file_dir, 'runParameters.xml'))
        # Validate!
        ...
        self.driver.find_element_by_xpath('//input[@type="file"]').send_keys(os.path.join(test_file_dir, 'InterOp/ExtractionMetricsOut.bin'))
        self.driver.find_element_by_xpath('//input[@type="file"]').send_keys(os.path.join(test_file_dir, 'InterOp/IndexMetricsOut.bin'))
        self.driver.find_element_by_xpath('//input[@type="file"]').send_keys(os.path.join(test_file_dir, 'InterOp/QMetricsOut.bin'))
        self.driver.find_element_by_xpath('//input[@type="file"]').send_keys(os.path.join(test_file_dir, 'InterOp/TileMetricsOut.bin'))
