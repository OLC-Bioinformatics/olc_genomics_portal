...
def upload_metadata(
    ...
    """
    print("Starting metadata upload process.")

    if clear_all:
        # Clear all existing entries
        print("Clearing all existing entries in the database.")
        clear_all_entries()
    ...
    print("Performing bulk creation of new entries.")
    bulk_create_entries(bulk_operations)

    print("Metadata upload process completed successfully.")
    # Uncomment if needed
