...
class SampleTestCase(TestCase):
    ...
    def test_vir_typer_result_ok(self):
        ...
        self.assertEquals([result.trimmed_quality_stdev for result in results], ['5.59', '6.23','6.10', '5.59'])
    ...
    def test_report_parse(self):
        ...
        results = VirTyperResults.objects.all()
        self.assertEquals([result.allele for result in results], ['00069', '00057', '00069', '00069'])
