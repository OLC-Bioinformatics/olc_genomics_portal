...
urlpatterns = [
    ...
    url(r'^create/', views.vir_typer_request, name='vir_typer_request'),
    url(r'^upload/(?P<vir_typer_pk>\d+)/$', views.vir_typer_upload, name='vir_typer_upload'),
    url(r'^results/(?P<vir_typer_pk>\d+)/$', views.vir_typer_results, name='vir_typer_results'),
    url(r'^edit/(?P<vir_typer_pk>\d+)/$', views.vir_typer_rename, name='vir_typer_rename'),
